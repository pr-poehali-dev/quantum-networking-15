const reviews = [
  ...
  {
    name: "Клиентка",
    text: "Добрый вечер! Ася, я в восторге! После пары процедур волосы буквально кусками перестали расти. Спасибо Вам большое! Я очень рада, что выбрала именно Вас!",
  },
  {
    name: "Клиентка",
    text: "Добрый вечер, Ася! Хотела вас поблагодарить! Вы лучшая в своём деле, все волосы ушли на ура, всем своим посоветовала вас. Такой как вы больше нет!",
  },
];
